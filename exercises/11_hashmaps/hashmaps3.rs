...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        let team_1_prev_score = scores.get(&team_1_name).copied().unwrap_or(Team { ..no_scores_team });
        let team_2_prev_score = scores.get(&team_2_name).copied().unwrap_or(Team { ..no_scores_team });
